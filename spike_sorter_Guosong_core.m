...
preSpike=20; % pre-spike time duration is 1 ms (20/20000), subject to change
postSpike=40; % post-spike time duration is 2 ms (40/20000), subject to change
clearRegion=1; % interval required between two neighboring spikes, subject to change
